...
private const val TAG = "AppProvider"
 ...
 const val CONTENT_AUTHORITY = "com.example.cinemahouse.provider"
    ...
    override fun query(
        ...
        when (match) {
            ...
            MOVIES_ID -> {
                ...
                queryBuilder.appendWhere("${MoviesContract.Columns.ID} = ")
                queryBuilder.appendWhereEscapeString("$movieId")
            }
